...
class ShotDataExporter:
    ...
    def __init__(self, output_file='shot_data.csv'):
        ...
        self.columns = [
            ...
            'confidence',
            # Friendly labels
            'type_label', 'direction_label', 'stroke_label'
        ]
    ...
    def add_shot(self, trajectory_analysis, shot_classification):
        ...
        shot_data = {
            ...
            ,
            'type_label': shot_classification.get('type_label', shot_classification.get('type', 'unknown')),
            'direction_label': shot_classification.get('direction_label', shot_classification.get('direction', 'unknown')),
            'stroke_label': shot_classification.get('stroke_label', shot_classification.get('stroke', 'unknown'))
        }
